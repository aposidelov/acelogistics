...
<?php foreach ($acecrew_assigned_sessions as $ses_id => $session) : ?>    
    ...
    <?php // print ctools_modal_text_button(t('Edit'), 'ace_modals/nojs/call/'.$ses_id.'/edit', t('Open'), 'acecrew_session_edit_button'); ?>
    <div class="acecrew_sessions_container">
        ...
        <div class="acecrew_session_buttons" id="acecrew_session_buttons_<?php print $ses_id; ?>">
            <a href="javascript:void(0)" data-call-id="<?php print $ses_id; ?>" onclick="" class="acecrew_session_edit_button">Edit</a>
